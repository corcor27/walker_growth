...
output2 = "/home/a.cot12/modeling/1492_walkers_200_test/base_image_1492.png" 
output1 = "/home/a.cot12/modeling/1492_walkers_200_test/threashold_image_1492.png" 
...
for t in range(0, scaled_time):
    ...
    if epoch_time == int(epoch_time):
        output = "/home/a.cot12/modeling/1492_walkers_200_test/%s.png" %(epoch_time)
        plt.imsave(output, container_array, cmap = 'gray')
	
    if (np.sum(container_array)/Vc) >= 0.99:
        break

output3 = "/home/a.cot12/modeling/1492_walkers_200_test/final.png" 
