...
output2 = "/home/a.cot12/modeling/1487_walkers_100/base_image_1487.png" 
output1 = "/home/a.cot12/modeling/1487_walkers_100/threashold_image_1487.png" 
...
for t in range(0, scaled_time):
    ...
    if epoch_time == int(epoch_time):
        output = "/home/a.cot12/modeling/1487_walkers_100/%s.png" %(epoch_time)
        plt.imsave(output, container_array, cmap = 'gray')
	
    if (np.sum(container_array)/Vc) >= 0.99:
        break

output3 = "/home/a.cot12/modeling/1487_walkers_100/final.png" 
