...
output2 = "/home/a.cot12/modeling/1527_walkers_200/base_image_1527.png" 
output1 = "/home/a.cot12/modeling/1527_walkers_200/threashold_image_1527.png" 
...
for t in range(0, scaled_time):
    ...
    if epoch_time == int(epoch_time):
        output = "/home/a.cot12/modeling/1527_walkers_200/%s.png" %(epoch_time)
        plt.imsave(output, container_array, cmap = 'gray')
	
    if (np.sum(container_array)/Vc) >= 0.99:
        break

output3 = "/home/a.cot12/modeling/1527_walkers_200/final.png" 
